...
<br>
 ...
 <br>
  ...
  <footer>
    ...
    <img style="heigth: 71px; width: 71px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/170px-HTML5_logo_and_wordmark.svg.png">
      <img style="heigth: 51px; width: 51px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/CSS3_logo_and_wordmark.svg/1200px-CSS3_logo_and_wordmark.svg.png">
      <img style="heigth: 61px; width: 61px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/1200px-Unofficial_JavaScript_logo_2.svg.png">
      <img style="heigth: 51px; width: 51px;" src="https://titrias.com/files/2022/04/typescript.png">
      <img style="heigth: 51px; width: 51px;" src="">
    <img style="heigth: 51px; width: 51px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/ISO_C%2B%2B_Logo.svg/1200px-ISO_C%2B%2B_Logo.svg.png">
    </div>
    <br>
    </footer>
    <br>
